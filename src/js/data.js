...
export const CHANGELOG = [
  { v: "2.8.0", t: "The wiring tool plans ports, and draws the loom", date: "2026-09-22", items: [
    ...
    "Driver Config, a new tool: set up each driver's controller — which stick is which, deadband, response curve, speed limits, slow mode and turbo, button bindings, rumble — and write it into your robot project as generated Java between marker lines. The preview shows the exact diff first, and writing needs the same per-project permission an agent needs.",
